...
def render_header():\
    ...
    \
    st.info("\uc0\u8505 \u65039  This form assesses potential eligibility based on standard transplant guidelines. It is not a medical diagnosis.")\
\
def render_results():\
...
\
    # Display Status Box\
    if status == 'eligible':\
        st.success("## \uc0\u9989  Likely Eligible for Evaluation")\
    ...
    \
        ...
        st.warning("## \uc0\u9888 \u65039  Conditional Eligibility")\
        ...
        st.error("## \uc0\u10060  Likely Ineligible at this time")\
...
\
    # Next Steps Section\
    st.markdown("---")\
    st.markdown("### \uc0\u10084 \u65039  Next Steps")\
    \
    if status == 'ineligible':\
...
\
        ...
        st.subheader("\uc0\u9878 \u65039  Body Measurements")\
        col1, col2 = st.columns(2)\
        with col1:\
...
\
        # 4. Medical History\
        st.subheader("\uc0\u55358 \u56954  Medical History")\
...
\
        # 5. Social Support\
        st.subheader("\uc0\u55357 \u56421  Social Support")\
